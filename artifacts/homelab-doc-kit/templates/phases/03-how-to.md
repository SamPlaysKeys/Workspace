...
## Output artifacts
A topic-grouped doc set. The reference layout that works:
...
## Visualization
Architecture + service map with real subnets/hardware. This is the "current/plan state" half of the eventual Fit view. Start from [../overview/lab-map.template.md](../overview/lab-map.template.md).

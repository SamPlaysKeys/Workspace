...
## Visualization
Render the environments + services as an aspirational topology (boxes for environments, lists for services). No IPs, no hardware — this is the dream map. Start from [../overview/lab-map.template.md](../overview/lab-map.template.md).

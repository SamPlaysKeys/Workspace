...
- **No nginx Unless Required:** Default to direct HTTP via Tailscale Serve pointing at the service port. Do not propose nginx or any reverse proxy unless the service requires TLS termination, path-based routing, or virtual hosting that Tailscale Serve cannot provide.

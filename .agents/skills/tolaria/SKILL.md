...
This skill provides instructions for working within a [Tolaria](https://github.com/refactoringhq/tolaria) vault. Use this skill when the user explicitly asks to work with Tolaria notes, types, views, or vault structures.

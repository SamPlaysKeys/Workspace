...
## Visualization
The Fit overlay: take the Phase 1/2 topology and the Phase 3 topology, render them stacked, and color each item green/amber/red by fit. This is the visual the reference homelab never had — and the one that makes "areas of growth" obvious at a glance.

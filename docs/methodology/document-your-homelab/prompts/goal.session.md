...
# Session — Phase 1: Goal (Ideal State)
...
1. **Intent.** "In one or two sentences, why does this lab exist?" Then: "What are your non-negotiables — things it must be, like 'everything local' or 'no monthly SaaS'?"
...
4. **Boundaries.** "What will this lab explicitly NOT do?" (Privacy, legal, risk lines.)
...
## Handoff
→ Run [achievable.session.md](../achievable.session.md) next. The Ideal-State doc is the baseline for scoping.
